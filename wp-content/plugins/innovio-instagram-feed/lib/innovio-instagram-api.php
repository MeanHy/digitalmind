...
include 'innovio-instagram-helper.php';

/**
 * Class InnovioInstagramApi
 */
class InnovioInstagramApi {
	...
	const INSTAGRAM_CODE = 'innovio_instagram_code';
	const INSTAGRAM_USER_ID = 'innovio_instagram_user_id';
	const INSTAGRAM_TOKEN = 'innovio_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'innovio_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'innovio_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'innovio_facebook_code';
	const FACEBOOK_TOKEN = 'innovio_facebook_access_token';

	const CONNECTION_TYPE = 'innovio_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new InnovioInstagramHelper();
	}

	/**
	 * @return InnovioInstagramApi
	 */
	 ...
	 *
	 * @see InnovioInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see InnovioInstagramApi::instagramExchangeCodeForToken()
	 */
