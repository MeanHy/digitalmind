...
/**
 * Class InnovioInstagramHelper
 */
class InnovioInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines innovio_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'innovio_instagram_image_atts',
			array(
