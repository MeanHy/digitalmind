...
if ( ! class_exists( 'InnovioCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class InnovioCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'innovio-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'innovio_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	InnovioCoreDashboardRestAPI::get_instance();
}