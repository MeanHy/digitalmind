...
if( ! function_exists( 'innovio_core_is_theme_registered' ) ) {
	function innovio_core_is_theme_registered() {
		return class_exists('InnovioCoreDashboard') ? InnovioCoreDashboard::get_instance()->is_theme_registered() : true;
	}
}