...
?>
            ...
            <div class="chartBox"><?php //print_r($yearWiseArray); ?>
                <h4 class='widhead'><?php _e('Most Used Categories','mtrl_framework');?></h4>
            ...
            <script type="text/javascript">
                   ...
                   var myChart5 = echarts.init(document.getElementById('mtrl_mostcats_byYear')); 
                    ...
                    itemGap: 10,
                            ...
                            series: [
                                {
                                    name: '<?php _e('Post in Category','mtrl_framework');?>',
                                    type: 'line',
                                    smooth: true,
                                    symbol:'none',
                                    symbolSize:2,
...
?>
            ...
            <div class="chartBox"><?php //print_r($yearWiseArray); ?>
                <h4 class='widhead'><?php _e('Least Used Categories','mtrl_framework');?></h4>
