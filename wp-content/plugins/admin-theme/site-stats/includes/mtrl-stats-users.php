...
?>    
            <div class="chartBox"><?php //print_r($monthsArray); ?>
                <h4 class='widhead'><?php _e('User Registrations By Months in Each Year','mtrl_framework');?></h4>
...
if(sizeof($yearWiseArray) > 0){
       ...
       //  echo "". $x_years." ".$y_total; ?>
            ...
            <div class="chartBox"><?php //print_r($yearWiseArray); ?>
                <h4 class='widhead'><?php _e('User Registrations By Year','mtrl_framework');?></h4>
            ...
            <script type="text/javascript">
                   ...
                   var myChart12 = echarts.init(document.getElementById('mtrl_users_byYear')); 
                    ...
                    itemGap: 10,
                            ...
                            series: [
                                {
                                    name: '<?php _e('User Registrations','mtrl_framework');?>',
                                    type: 'line',
                                    smooth: true,
                                    symbol:'none',
                                    symbolSize:2,
...
<?php } ?>
        ...
        ?>
            <div class="chartBox"><?php //print_r($usersCount); ?>
                <h4 class='widhead'><?php _e('User Count and Type','mtrl_framework');?></h4>
                <div id="rolewiseChart" style='height:190px;'></div>
            </div>
            ...
            <script type="text/javascript">
              ...
              var option = {
                color: ['<?php echo $getcolor[0]; ?>','<?php echo $getcolor[1]; ?>','<?php echo $getcolor[2]; ?>','<?php echo $getcolor[3]; ?>','<?php echo $getcolor[4]; ?>','<?php echo $getcolor[5]; ?>'],
                    ...
                    series : [
                        {
                            name:'<?php _e('User Count','mtrl_framework');?>',
                            type:'pie',
                            radius : [20, '81%'],
                            roseType : 'radius',
                            center: ['60%', '50%'],
