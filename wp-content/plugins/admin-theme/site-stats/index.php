...
function mtrl_catstats_add_dashboard() {
  wp_add_dashboard_widget( 'catstats_wp_dashboard', __('Category Statistics', 'mtrl_framework') , 'mtrl_catstats_dashboard_output','','','column2' );
}
...
function mtrl_userstats_add_dashboard() {
  wp_add_dashboard_widget( 'userstats_wp_dashboard', __('User Statistics', 'mtrl_framework') , 'mtrl_userstats_dashboard_output','','','column4' );
}
...
function mtrl_commentstats_add_dashboard() {
  wp_add_dashboard_widget( 'commentstats_wp_dashboard', __('User Comments', 'mtrl_framework') , 'mtrl_commentstats_dashboard_output','','','column3' );
}
