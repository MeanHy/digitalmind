...
<?php
    ...
    */
    ...
    foreach ($country_list as $cname) {
      ...
      <div class="chartBox">
        <h4 class="widhead"><?php _e('Visits (by Country) in last ','mtrl_framework');?><?php echo $days; ?><?php _e(' days','mtrl_framework');?></h4>
...
<script type="text/javascript">
        ...
        var option = {
                ...
                series: [
                    {
                        name: '<?php _e('Visits in last ','mtrl_framework');?><?php echo $days; ?><?php _e(' days','mtrl_framework');?>',
                        type: 'map',
                        mapType: 'world',
                        roam: true,
                        mapLocation: {
