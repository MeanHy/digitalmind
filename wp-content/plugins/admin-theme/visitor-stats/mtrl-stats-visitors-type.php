...
<script type="text/javascript">
        ...
        var option = {
                ...
                // Add legend
                legend: {
                    data: ['<?php _e('Unique Visitors','mtrl_framework');?>','<?php _e('Total Visitors','mtrl_framework');?>']
                },
                toolbox: {
                  orient: 'vertical',
                    show : true,
                ...
                series: [
                    {
                        name: '<?php _e('Unique Visitors','mtrl_framework');?>',
                        type: 'bar',
                        smooth: true,
                        symbol:'none',
                        symbolSize:2,
                    ...
                    {
                        name: '<?php _e('Total Visitors','mtrl_framework');?>',
                        type: 'bar',
                        smooth: true,
                        symbol:'none',
                        symbolSize:2,
