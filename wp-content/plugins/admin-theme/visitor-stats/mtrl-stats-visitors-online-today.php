...
<div class="totalviewscount">
        <span class='viewslabel'><?php _e('Page Views<br>Today','mtrl_framework');?></span>
        <span class="count"><?php echo $count; ?></span>
    </div>

      <div class="chartBox">
         <h4 class='widhead'><?php _e('Page Views Today','mtrl_framework');?> (<?php _e('on','mtrl_framework');?> <?php echo $today_date; ?>) <?php _e('By Hour','mtrl_framework');?></h4>
...
<script type="text/javascript">
        ...
        var option = {
                  ...
                  orient: 'vertical',
                    ...
                    feature : {
                        ...
                        magicType : {
                          show: true, 
                          title : {
                              line : '<?php _e('Line','mtrl_framework');?>',
                ...
                series: [
                    {
                        name: '<?php _e('Page Views','mtrl_framework');?>',
                        type: 'bar',
                        smooth: true,
                        symbol:'none',
                        symbolSize:2,
