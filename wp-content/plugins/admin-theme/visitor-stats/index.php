...
function mtrl_visitors_type() {
	wp_add_dashboard_widget( 'mtrl_visitors_type_wp_dashboard', __('Visitors in last 15 days', 'mtrl_framework') , 'mtrl_visitors_type_output','','','side' );
}
...
function mtrl_user_type() {
	wp_add_dashboard_widget( 'mtrl_user_type_wp_dashboard',  __('Users in last 15 days', 'mtrl_framework') , 'mtrl_user_type_output','','','column3' );
}
...
function mtrl_browser_type() {
	wp_add_dashboard_widget( 'mtrl_browser_type_wp_dashboard', __('Browsers Used', 'mtrl_framework') , 'mtrl_browser_type_output','','','side' );
}
...
function mtrl_platform_type() {
	wp_add_dashboard_widget( 'mtrl_platform_type_wp_dashboard',  __('Platforms Used', 'mtrl_framework') , 'mtrl_platform_type_output','','','column3' );
}
...
function mtrl_country_type() {
	wp_add_dashboard_widget( 'mtrl_country_type_wp_dashboard', __('Visits by Country', 'mtrl_framework') , 'mtrl_country_type_output','','','column4' );
}
