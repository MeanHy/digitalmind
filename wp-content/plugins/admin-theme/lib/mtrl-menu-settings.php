...
function mtrl_menumng_settings_page(){
	...
	//remove the $plug value validation for multi-language translation in mtrl-settings.php line 34
	if (isset($plug)){
	...
	echo '<div class="wrap"><h1>'; esc_html_e('Admin Menu Management', 'mtrl_framework'); echo '</h1><div id="mtrl-enabled" class="mtrl-connectedSortable">';
			...
			if(strpos($menuarr[4], "wp-menu-separator") !== false){
				...
				echo "<div class='mtrlmenu ".$disabled."' data-id='".$tabid."' data-menu-id='".$sid."'>
						...
						<div class='mtrlmenu-wrap'>
							...
							<span class='mtrltext'>".strip_tags($menuarr[0])."</span>
	...
	echo "<li>"; esc_html_e('Drag and Drop', 'mtrl_framework'); echo "<span class='wp-menu-image dashicons-before dashicons-editor-expand'></span> "; esc_html_e('menu and sub menu items to rearrange.', 'mtrl_framework'); echo "</li>";
	echo "<li>"; esc_html_e('Click on', 'mtrl_framework'); echo " <span class='wp-menu-image dashicons-before dashicons-visibility'></span> "; esc_html_e('icon to show or hide the menu or submenu item.', 'mtrl_framework'); echo "</li>";
	...
	echo "<li>"; esc_html_e('Click on save menu button after editing.', 'mtrl_framework'); echo "</li></ul>";

	echo '<p class="submit" style="padding-left:0px;margin-top:0px;padding-top:0px;"><input type="button" name="mtrl-savemenu" id="mtrl-savemenu" class="button button-primary" value="'; esc_html_e('Save Menu', 'mtrl_framework'); echo '"> <input type="button" name="mtrl-resetmenu" id="mtrl-resetmenu" class="button button-primary" value="'; esc_html_e('Reset to Original', 'mtrl_framework'); echo '"></p>';
...
function mtrl_savemenu() {
	...
	//don't alow changing mennu name since doesn't work with translation
