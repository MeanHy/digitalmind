...
function mtrl_custom_login() {
   ...
   /* $url = plugins_url('/', __FILE__) . '../js/mtrl-login-scripts.js';
	...
	//Display favicon from admin theme if the site icon is not set
	if (!get_site_icon_url()){
		if ($mtrladmin['favicon']['url']){
		echo '<link rel="shortcut icon" href="' . $mtrladmin['favicon']['url'] . '" type="image/x-icon" />';
			}
		if ($mtrladmin['iphone_icon']['url']){
		echo '<!-- For iPhone --><link rel="apple-touch-icon-precomposed" href="' . $mtrladmin['iphone_icon']['url'] . '">';
			}
		if ($mtrladmin['iphone_icon_retina']['url']){
		echo '<!-- For iPhone 4 Retina display --><link rel="apple-touch-icon-precomposed" sizes="114x114" href="' . $mtrladmin['iphone_icon_retina']['url'] . '">';
			}
		if ($mtrladmin['ipad_icon']['url']){
		echo '<!-- For iPad --><link rel="apple-touch-icon-precomposed" sizes="72x72" href="' . $mtrladmin['ipad_icon']['url'] . '">';
			}
		if ($mtrladmin['ipad_icon_retina']['url']){
		echo '<!-- For iPad Retina display --><link rel="apple-touch-icon-precomposed" sizes="144x144" href="' . $mtrladmin['ipad_icon_retina']['url'] . '">';
			}
	}
	...
	if ($mtrladmin['google_nav']['font-backup']){
	echo "body{font-family:" . $mtrladmin['google_nav']['font-backup'] . "!important;}";
		}
