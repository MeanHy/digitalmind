...
function mtrl_menumng_settings_page(){
	...
	echo '<p class="submit" style="padding-left:0px;margin-top:0px;padding-top:0px;"><input type="button" name="mtrl-savemenu1" id="mtrl-savemenu1" class="button button-primary" value="Save - Disabled for Demo"> <input type="button" name="mtrl-resetmenu" id="mtrl-resetmenu" class="button button-primary" value="Reset to Original"></p>';
