...
function mtrl_panel_settings(){
	...
	if($showtabs){
			add_menu_page('Admin Theme Settings', __('Admin Theme Settings', 'mtrl_framework'), $mtrladmin_permissions, 'mtrl_permission_settings', 'mtrl_permission_settings_page');
...
<div class="wrap">
	...
	<h1><?php esc_html_e('Admin Theme Settings','mtrl_framework'); ?></h1>
...
<?php if($mtrl_plugin_settings) { ?>
	<form method="post" action="<?php echo esc_url(add_query_arg(array())); ?>" id="mtrladmin_settings_form">
		<table class="form-table">
			...
			<tr>
				<th scope="row">
				<?php esc_html_e('Plugin Access Rights','mtrl_framework'); ?>
				</th>
				<td>
					<fieldset>
						<p>
							<label>
								...
								<?php if ( !$isMultisite ) : ?>
									...
									<?php esc_html_e('On a single site installation this is usually the same as the Administrator role.','mtrl_framework'); ?>
									</span>
								<?php endif; ?>
							</label>
						</p>
						...
						<p>
							<label>
								<input type="radio" name="plugin_access" value="manage_options"
									...
									>
									<?php esc_html_e('User the "manage_options" capability','mtrl_framework'); ?>

								<br><span class="description">
								<?php esc_html_e('Only Administrators have this capability by default.','mtrl_framework'); ?>
								</span>
							</label>
						</p>
						...
						<p>
							<label>
								<input type="radio" name="plugin_access" value="specific_user"
									...
									<?php esc_html_e('Only the current user','mtrl_framework'); ?>

								<br>
								<span class="description">
									<?php esc_html_e('Login:','mtrl_framework'); ?> <?php echo $currentUser->user_login; ?>,
									<?php esc_html_e('user ID:','mtrl_framework'); ?> <?php echo get_current_user_id(); ?>
								</span>
							</label>
						</p>
					</fieldset>
					...
					<p>
						<label>
							...
							>
							<?php esc_html_e('Hide the "Admin Theme" entry on the "Plugins" page from other users.','mtrl_framework'); ?><br><span class="description">(<?php esc_html_e('Other users are all users expect selected user type or user above.','mtrl_framework'); ?>)</span>
						</label>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
				<?php esc_html_e('Menu Management','mtrl_framework'); ?>
				</th>
				<td>
					<p>
						<label>
							<input type="checkbox" name="mtrl_disable_menumng" value="1"
								...
								<?php disabled( $isMultisite && !is_super_admin() ); ?>
							>
							<?php esc_html_e('Check to','mtrl_framework'); ?> <u>DISABLE</u> <?php esc_html_e('Admin Theme MENU MANAGEMENT Addon.','mtrl_framework'); ?><br><span class="description"><?php esc_html_e('Generally disabled when the admin menu management is managed by some other premium plugins (providing similar functionality).','mtrl_framework'); ?></span>
						</label>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
				<?php esc_html_e('User Based Menu Management','mtrl_framework'); ?>
				</th>
				<td>
					<p>
						<label>
							<input type="checkbox" name="mtrl_disable_admin_menumng" value="1"
								...
								<?php disabled( $isMultisite && !is_super_admin() ); ?>
							>
							<?php esc_html_e('Check to show Original Admin menu to administrator or super admin user.','mtrl_framework'); ?> <br><span class="description"><?php esc_html_e('Means the edited menu (from Menu Management Addon) will be shown to all users except administrator or super admin users.','mtrl_framework'); ?></span>
						</label>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
				<?php esc_html_e('Admin Theme on Admin Pages','mtrl_framework'); ?>
				</th>
				<td>
					<p>
						<label>
							<input type="checkbox" name="mtrl_disable_admintheme" value="1"
								...
								<?php disabled( $isMultisite && !is_super_admin() ); ?>
							>
							<?php esc_html_e('Check to','mtrl_framework'); ?> <u>DISABLE</u> <?php esc_html_e('Admin Theme on ADMIN PAGES after successful user login.','mtrl_framework'); ?>
						</label>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
				<?php esc_html_e('Admin Theme on Login Page','mtrl_framework'); ?>
				</th>
				<td>
					<p>
						<label>
							<input type="checkbox" name="mtrl_disable_logintheme" value="1"
								...
								<?php disabled( $isMultisite && !is_super_admin() ); ?>
							>
							<?php esc_html_e('Check to','mtrl_framework'); ?> <u>DISABLE</u> <?php esc_html_e('Admin Theme on LOGIN PAGE.','mtrl_framework'); ?>
						</label>
					</p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<p>
						...
						<br>Selected site &quot;Admin theme options&quot; will be applied to all the sites on network. All the sites on network will have same look and feel. &quot;Individual site settings&quot; means all the sites will have their own individual settings.
