...
function mtrl_admintopbar_links(){
       ...
       $mtrladmin = mtrladmin_network($mtrladmin);       
        ...
        if(isset($mtrladmin[$element]) && $mtrladmin[$element] != "1" && $mtrladmin[$element] == "0" && !$mtrladmin[$element]){
			...
			//Hide the WP icon when hover on site names with no favicon set
			$str .= '#wpadminbar #wp-admin-bar-wp-logo > .ab-item .ab-icon:before {content:" "!important;}
			#wpadminbar .quicklinks li .blavatar:before {content:" "!important;}
			#wp-admin-bar-wp-logo>.ab-item .ab-icon { background: url("' . $mtrladmin['favicon']['url'] . '") no-repeat;}
			#wpadminbar .quicklinks li div.blavatar { background: url("' . $mtrladmin['favicon']['url'] . '") no-repeat;}
			//for buddypress members stats metabox
			div#community-profile-page li.bp-blogs-profile-stats:before {content:" "!important;}
			div#community-profile-page li.bp-blogs-profile-stats {background: url("' . $mtrladmin['favicon']['url'] . '") no-repeat; padding-left:16px}
