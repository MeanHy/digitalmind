...
/*ADDED in Material Admin - END*/
    ...
    $args = array(
        ...
        'display_name'         => __( 'Admin Theme', 'mtrl_framework' ),
        ...
        'menu_title'           => __( 'Admin Theme', 'mtrl_framework' ),
        'page_title'           => __( 'Admin Theme', 'mtrl_framework' ),
...
*/
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    /*array(
                        ...
                        'type' => 'switch',
                        'title' => __('Enable Admin Theme Panel for users', 'mtrl_framework'),
                        'desc' => __('Check ON to show Admin Theme Settings Panel to all Users, OFF to show only to Admin User.', 'mtrl_framework'),
                        'default' => '0'// 1 = on | 0 = off
                    ),*/


                    array("title" => __('Admin Menu Style', 'mtrl_framework'),
                        "desc" => __('Select the main admin menu display style.', 'mtrl_framework'),
                        "id" => "menu-style",
                        "default" => "style1",
                        "type" => "select",
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    array("title" => __('Back to main site Link', 'mtrl_framework'),
                        "desc" => __('Select to show or hide back to main site link on login page.', 'mtrl_framework'),
                        "id" => "backtosite_login_link",
                        "default" => '0',
                        "type" => "switch"),

                    array("title" => __('Forgot Password Link', 'mtrl_framework'),
                        "desc" => __('Select to show or hide Forgot Password link on login page.', 'mtrl_framework'),
...
/*                    array("title" => "Admin Top Bar Style",
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Top Bar Menu', 'mtrl_framework'),
                        'desc' => __('Check ON to show  top bar menu and submenu links, OFF to hide.', 'mtrl_framework'),
                        'default' => '0'// 1 = on | 0 = off
                    ),
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => __('Top Bar Theme Admin Menu', 'mtrl_framework'),
                    ...
                    array(
                        ...
                        'desc' => __('Enter the greeting word for logged in user. Default is blank. Eg: Welcome ', 'mtrl_framework'),
                        'default' => '',
                    ),
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    array("title" => __('User Profile Type', 'mtrl_framework'),
                        "desc" => __('Select the user profile display style.', 'mtrl_framework'),
                        "id" => "user-profile-style",
                        "default" => "style2",
                        "type" => "radio",
                        "options" => array(
                            'style1' => __('User Profile in Menu', 'mtrl_framework'),
                            'style2' => __('Default User Profile in Top Bar', 'mtrl_framework'),
                            'style3' => __('Only Logout Link in Top bar (No user profile)', 'mtrl_framework'),
                        ),
                    ),
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    array(
                        "title" => __('Custom Widgets to display on Dashboard', 'mtrl_framework'),
                        "desc" => __('Select the widgets to display on dashboard. These widgets are added by this plugin.', 'mtrl_framework'),
                        ...
                        "default" => array(
                            ...
                            "mtrl_commentstats_add_dashboard" => 0,
                        ...
                        "type" => "checkbox",
                        "options" => array(
                            'mtrl_visitors_type' => __('Visitors in Last 15 days', 'mtrl_framework'),
                            'mtrl_user_type' => __('Users in last 15 days', 'mtrl_framework'),
                            'mtrl_browser_type' => __('Browsers Used', 'mtrl_framework'),
                            'mtrl_platform_type' => __('Platforms Used', 'mtrl_framework'),
                            'mtrl_country_type' => __('Visits by Country', 'mtrl_framework'),
                            'mtrl_today_visitors' => __('Today Page Views & Online Users', 'mtrl_framework'),
                            'mtrl_pagestats_add_dashboard' => __('Pages Count & Type', 'mtrl_framework'),
                            'mtrl_poststats_add_dashboard' => __('Posts Statistics', 'mtrl_framework'),
                            'mtrl_commentstats_add_dashboard' => __('User Comments', 'mtrl_framework'),
                            'mtrl_catstats_add_dashboard' => __('Category Statistics', 'mtrl_framework'),
                            'mtrl_userstats_add_dashboard' => __('User Statistics', 'mtrl_framework'),
                        ),
                    ),


                    array("title" => __('Select Default Widgets to display on Dashboard', 'mtrl_framework'),
                        "desc" => __('Select the widgets to display on dashboard. This includes default dashboard widgets<br>Some default widgets might not be found in your current version.', 'mtrl_framework'),
                        "id" => "dashboard-default-widgets",
                        "default" => "",
                        "type" => "checkbox",
                        "options" => array(
                            'welcome_panel' => __('Welcome Panel', 'mtrl_framework'),
                            'dashboard_primary' => __('News', 'mtrl_framework'),
                            'dashboard_quick_press' => __('Quick Draft', 'mtrl_framework'),
                            'dashboard_recent_drafts' => __('Recent Drafts', 'mtrl_framework'),
                            'dashboard_recent_comments' => __('Recent Comments', 'mtrl_framework'),
                            'dashboard_right_now' => __('At a Glance', 'mtrl_framework'),
                            'dashboard_activity' => __('Activity', 'mtrl_framework'),
                            'dashboard_incoming_links' => __('Incoming Links', 'mtrl_framework'),
                            'dashboard_plugins' => __('Plugins Widget', 'mtrl_framework'),
                            'dashboard_secondary' => __('Secondary Widget', 'mtrl_framework')
                        ),
                    ),
                    ...
                    array(
                        'id' => 'dashboard-widget-colors',
                        'type' => 'text',
                        'title' => __('Dashboard Widgets Color Pallette', 'mtrl_framework'),
                        'subtitle' => __('Enter the valid color values in #HEX format separated by comma(,). This colors will be displayed in dashboard widgets. Min. 5 colors needed.', 'mtrl_framework'),
                        'default' => '#e90006,#1093f5,#eb1460,#46af4a,#ff5505,#009587,#ff9800,#00bbd5,#ffc100,#00a6f6,#795446,#3d4db7,#9c1ab1,#ccdd1e,#6633b9,#88c340,#ffec16,#5e7c8b,#9d9d9d',
                    ),
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    array("title" => __('Floating Menu Position', 'mtrl_framework'),
                        "desc" => __('Select the position of floating menu.', 'mtrl_framework'),
                        "id" => "floatingmenu-pos",
                        "default" => "br",
                        "type" => "select",
                        "options" => array(
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('Floating Menu Link 1', 'mtrl_framework'),
                        'subtitle' => __('Enter the links you want to show in the floating menu. Eg: Link Title|icon classname|http://sitename/mypagelink.<br>You can also use the keywords in url link. eg: ADMINURL will be replaced with your site admin url.', 'mtrl_framework'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('Floating Menu Link 2', 'mtrl_framework'),
                        'subtitle' => __('Enter the links you want to show in the floating menu. Eg: Link Title|icon classname|http://sitename/mypagelink.<br>You can also use the keywords in url link. eg: ADMINURL will be replaced with your site admin url.', 'mtrl_framework'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('Floating Menu Link 3', 'mtrl_framework'),
                        'subtitle' => __('Enter the links you want to show in the floating menu. Eg: Link Title|icon classname|http://sitename/mypagelink.<br>You can also use the keywords in url link. eg: ADMINURL will be replaced with your site admin url.', 'mtrl_framework'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('Floating Menu Link 4', 'mtrl_framework'),
                        'subtitle' => __('Enter the links you want to show in the floating menu. Eg: Link Title|icon classname|http://sitename/mypagelink.<br>You can also use the keywords in url link. eg: ADMINURL will be replaced with your site admin url.', 'mtrl_framework'),
                        'default' => '',
                    ),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('Floating Menu Link 5', 'mtrl_framework'),
                        'subtitle' => __('Enter the links you want to show in the floating menu. Eg: Link Title|icon classname|http://sitename/mypagelink.<br>You can also use the keywords in url link. eg: ADMINURL will be replaced with your site admin url.', 'mtrl_framework'),
                        'default' => '',
                    ),
    ...
    Reduk::setSection( $opt_name, array(
        'title' => __('Email Settings', 'mtrl_framework'),
        'icon' => 'el-icon-css',
        'fields' => array(
            ...
            array(
                ...
                'desc' => __('Change the from email address used in an email sent using the mail function. (Default is blank). Change it to your personal brand or domain name. To avoid being marked as spam make sure the email is from the same domain as your website.', 'ultra_framework'),
                'default' => '',
            ),
            ...
            array(
                ...
                'desc' => __('Change the from name used in an email sent using the wp_mail function. (Default is WP). Change it to your personal brand or domain name.', 'ultra_framework'),
                'default' => '',
            ),
    ...
    Reduk::setSection( $opt_name, array(
                ...
                'fields' => array(
                    ...
                    array("title" => __('Footer Text', 'mtrl_framework'),
                        "desc" => __('Enter the text that displays in the footer bar. HTML markup can be used.', 'mtrl_framework'),
                        "id" => "footer_text",
                        "default" => "©2021 <a style='font-size: 13px;' href='https://Ecomyze.com/'>Ecomyze O2O2O</a> V1.0",
                        "type" => "editor"),

                    array("title" => __('Footer Version', 'mtrl_framework'),
                    ...
                    array("title" => "Screen Help Tab",
                        ...
                        array(
                            ...
                            'mode'     => 'css',
                            'theme'    => 'monokai',
                            'desc'     => 'In case if you need to overwrite any CSS setting, you can add !important at the end of CSS property. eg: color: #da2234 !important; <br/> You can use dynamic css variables in custom css code. <pre> Eg: .css-selector{background: var(--tp-primary-color); border-color: var(--tp-primary-color);} </pre> Following is the list of defined css variables based on your settings configured. <pre> :root {--tp-primary-color: #e90006; --tp-page-bg-background-color: #eeeeee; --tp-heading-color: #424242; --tp-body-text-color: #757575; --tp-link-color-regular: #e90006; --tp-link-color-hover: #424242; --tp-menu-bg-background-color: #ffffff; --tp-menu-color: #757575; --tp-menu-hover-color: #212121; --tp-submenu-color: #757575; --tp-menu-primary-bg: #eeeeee; --tp-menu-secondary-bg: #ffffff; --tp-box-bg-background-color: #ffffff; --tp-box-head-bg-background-color: #ffffff; --tp-box-head-color: #424242; --tp-button-primary-bg: #e90006; --tp-button-primary-hover-bg: #e90006; --tp-button-secondary-bg: #bdbdbd; --tp-button-secondary-hover-bg: #9e9e9e; --tp-button-text-color: #ffffff; --tp-form-bg: transparent; --tp-form-text-color: #757575; --tp-form-border-color: #dedede; --tp-logo-bg: transparent; --tp-topbar-menu-color: #ffffff; --tp-topbar-menu-bg-background-color: #e90006; --tp-topbar-submenu-color: #757575; --tp-topbar-submenu-bg: #ffffff; --tp-topbar-submenu-hover-bg: #eeeeee;} </pre>',
                            'default'  => ""
                        ),
                    ...
                    array("title" => __('3D Hover Effects - Rise Position', 'mtrl_framework'),
                        "desc" => __('Enable or disable 3D effects rising effect on mouse hover of any element.', 'mtrl_framework'),
                        "id" => "hover3d_translate",
                        "default" => '1',
                        "type" => "switch"),

                    array("title" => __('3D Hover Effects - Shadow', 'mtrl_framework'),
                        "desc" => __('Enable or disable 3D effects shadow on mouse hover of any element.', 'mtrl_framework'),
                        "id" => "hover3d_shadow",
                        "default" => '1',
                        "type" => "switch"),
