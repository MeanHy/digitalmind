        ...
        class RedukFramework {
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( ! empty ( $this->args['opt_name'] ) ) {
					...
					//var_dump(array( $this, '_options_page' ));
					//exit();
            ...
            public function _options_page() {
                ...
                if ( $this->args['menu_type'] == 'hidden' ) {
                    ...
                    $this->page = call_user_func( 'add_menu_page', $this->args['page_title'], __($this->args['menu_title'],'mtrl_framework'), $this->args['page_permissions'], $this->args['page_slug'], array(
                        &$this,
                        'generate_panel'
                    ...
                    if ( true === $this->args['allow_sub_menu'] ) {
                        if ( ! isset ( $section['type'] ) || $section['type'] != 'divide' ) {
                            foreach ( $this->sections as $k => $section ) {
                                ...
                                // ONLY for non-wp.org themes OR plugins. Theme-Check alert shown if used and IS theme.
                                call_user_func( 'add_submenu_page', $this->args['page_slug'], $section['title'], __($section['title'],'mtrl_framework'), $this->args['page_permissions'], $this->args['page_slug'] . '&tab=' . $k,
            ...
            public function get_header_html( $field ) {
                ...
                if ( ! empty ( $th ) ) {
                    $th = '<div class="reduk_field_th">' . esc_html__($th, 'mtrl_framework') . '</div>';
                }
...
//                            }
            ...
            public function section_menu( $k, $section, $suffix = "", $sections = array() ) {
                ...
                if ( isset ( $section['type'] ) && $section['type'] == "divide" ) {
                    ...
                    $string .= '<a href="javascript:void(0);" id="' . esc_attr( $k . $suffix ) . '_section_group_li_a" class="reduk-group-tab-link-a" data-key="' . esc_attr( $k ) . '" data-rel="' . esc_attr( $k . $suffix ) . '">' . $extra_icon . $icon . '<span class="group_title">' . esc_html__(wp_kses_post( $section['title']), 'mtrl_framework') . '</span></a>';
            ...
            public function _field_input( $field, $v = null ) {
                ...
                if ( isset ( $field['type'] ) ) {
                     ...
                     */
                        ...
                        echo ( isset ( $field['description'] ) && $field['type'] != "info" && $field['type'] !== "section" && ! empty ( $field['description'] ) ) ? '<div class="description field-desc">' . esc_html__($field['description'], 'mtrl_framework') . '</div>' : '';
