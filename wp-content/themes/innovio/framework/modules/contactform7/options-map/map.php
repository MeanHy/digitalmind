...
if ( ! function_exists('innovio_mikado_contact_form_7_options_map') ) {

	function innovio_mikado_contact_form_7_options_map() {
		
		innovio_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'innovio' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = innovio_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'innovio' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'innovio' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'innovio' ),
		));
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'innovio' ),
			)
		);
		...
		$typography_text_row2 = innovio_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = innovio_mikado_add_admin_row(
			array(
		...
		$typography_label_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'innovio' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = innovio_mikado_add_admin_row(
			array(
		...
		$background_border_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'innovio' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'innovio' )
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'innovio' )
			)
		);
		
		$background_border_row2 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'innovio' ),
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'innovio' )
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'innovio' )
			)
		);
		
		$background_border_row3 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'innovio' ),
				'description' => esc_html__('Setup form elements padding', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = innovio_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'innovio' ),
				'description' => esc_html__( 'Setup form elements margin', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = innovio_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'innovio' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'innovio' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'innovio' ),
				'description' => esc_html__( 'Setup button text typography', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = innovio_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = innovio_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'innovio' ),
				'description' => esc_html__( 'Setup button background and border style', 'innovio' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'innovio' )
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'innovio' )
			)
		);
		
		$button_background_border_row2 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'innovio' )
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'innovio' )
			)
		);
		
		$button_background_border_row3 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'innovio' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'innovio' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = innovio_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'innovio')
		));

		//Text Typography

		$typography_text_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'innovio'),
			'description'	=> esc_html__('Setup typography for form elements text', 'innovio'),
		...
		$typography_text_row1 = innovio_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = innovio_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = innovio_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'innovio'),
			'description'	=> esc_html__('Setup typography for form elements label', 'innovio'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = innovio_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = innovio_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'innovio'),
			'description'	=> esc_html__('Setup form elements background and border style', 'innovio'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = innovio_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = innovio_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = innovio_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'innovio'),
			'description'	=> esc_html__('Setup form elements padding', 'innovio' ),
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = innovio_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'innovio'),
			'description'	=> esc_html__('Setup form elements margin', 'innovio'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = innovio_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'innovio'),
			'description'	=> esc_html__('Setup button text typography', 'innovio'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = innovio_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = innovio_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = innovio_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'innovio'),
			'description'	=> esc_html__('Setup button background and border style', 'innovio'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = innovio_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = innovio_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = innovio_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = innovio_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'innovio')
        ));
        ...
        $typography_label_row3 = innovio_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = innovio_mikado_add_admin_row(array(
	...
	add_action( 'innovio_mikado_action_options_map', 'innovio_mikado_contact_form_7_options_map', innovio_mikado_set_options_map_position( 'contact_form_7' ) );
}