...
if ( ! class_exists( 'InnovioMikadoWelcomePage' ) ) {
	class InnovioMikadoWelcomePage {
		/**
		 * singleton class
		 */
		...
		/**
		 * get the instance of InnovioWelcomePage
		 *
		 * @return self
		 */
		...
		function welcome_page_content() {
			...
			echo innovio_mikado_get_html_module_template_part( 'templates/welcome', 'welcome', '', $params );
		}
		...
		function enqueue_styles( $hook ) {
			if ( $hook === 'appearance_page_innovio_mikado_welcome_page' ) {
				wp_enqueue_style( 'innovio-mikado-welcome-page-style', MIKADO_FRAMEWORK_MODULES_ROOT . '/welcome/assets/admin/css/welcome.min.css' );
			}
		}
	}
}

InnovioMikadoWelcomePage::get_instance();