<div class="wrap about-wrap mkdf-welcome-page">
    <div class="mkdf-welcome-page-heading">
        <div class="mkdf-welcome-page-logo">
            <img src="<?php echo esc_url( MIKADO_FRAMEWORK_MODULES_ROOT . '/welcome/assets/img/logo.png' ); ?>" alt="<?php esc_attr_e( 'Qode Logo', 'innovio' ); ?>"/>
        </div>
        <h1 class="mkdf-welcome-page-title">
			<?php echo sprintf( esc_html__( 'Welcome to %s', 'innovio' ), $theme_name ); ?>
    ...
    <div class="mkdf-welcome-page-content">
        <div class="mkdf-welcome-page-screenshot">
            <img src="<?php echo esc_url( $theme_screenshot ); ?>" alt="<?php esc_attr_e( 'Theme Screenshot', 'innovio' ); ?>"/>
        </div>
        <div class="mkdf-welcome-page-links-holder">
            <div class="mkdf-welcome-page-install-core">
                <p><?php esc_html_e( 'Please install and activate required plugins in order to gain access to all the theme functionalities and features.', 'innovio' ); ?></p>
                <a class="mkdf-welcome-page-install-button" href="<?php echo add_query_arg( array( 'page' => 'install-required-plugins&plugin_status=install' ), esc_url( admin_url( 'themes.php' ) ) ); ?>">
					<?php esc_html_e( 'Install Required Plugins', 'innovio' ); ?>
                </a>
            </div>

            <h3><?php esc_html_e( 'Useful Links:', 'innovio' ); ?></h3>
            <ul class="mkdf-welcome-page-links">
                <li>
                    <a href="https://helpcenter.qodeinteractive.com" target="_blank"><?php esc_html_e( 'Help Center', 'innovio' ); ?></a>
                </li>
                <li>
                ...
                <li>
                    <a href="https://qodeinteractive.com/" target="_blank"><?php esc_html_e( 'All Our Themes', 'innovio' ); ?></a>
                </li>
                <li>
