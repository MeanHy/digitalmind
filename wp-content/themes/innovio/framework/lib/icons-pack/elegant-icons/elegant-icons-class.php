...
if ( ! function_exists( 'innovio_mikado_add_font_elegant_icon_pack' ) ) {
	function innovio_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new InnovioMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_font_elegant_icon_pack_option' ) ) {
	function innovio_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_social_options', 'innovio_mikado_add_font_elegant_icon_pack_option' );
}

class InnovioMikadoClassIconsFontElegant implements iInnovioMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
