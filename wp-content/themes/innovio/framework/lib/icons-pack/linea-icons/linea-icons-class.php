...
if ( ! function_exists( 'innovio_mikado_add_linea_icon_pack' ) ) {
	function innovio_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new InnovioMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_linea_icon_pack_option' ) ) {
	function innovio_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_linea_icon_pack_option' );
}

class InnovioMikadoClassLineaIcons implements iInnovioMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
