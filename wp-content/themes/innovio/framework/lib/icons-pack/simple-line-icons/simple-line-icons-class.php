...
if ( ! function_exists( 'innovio_mikado_add_simple_line_icon_pack' ) ) {
	function innovio_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new InnovioMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_simple_line_icon_pack_option' ) ) {
	function innovio_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_social_options', 'innovio_mikado_add_simple_line_icon_pack_option' );
}

class InnovioMikadoClassSimpleLineIcons implements iInnovioMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'innovio'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'innovio'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'innovio'),
            'icon-social-facebook'    => esc_html__('Facebook', 'innovio'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'innovio'),
            'icon-social-github'      => esc_html__('Github', 'innovio'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'innovio'),
            'icon-social-instagram'   => esc_html__('Instagram', 'innovio'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'innovio'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'innovio'),
            'icon-social-reddit'      => esc_html__('Reddit', 'innovio'),
            'icon-social-skype'       => esc_html__('Skype', 'innovio'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'innovio'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'innovio'),
            'icon-social-spotify'     => esc_html__('Spotify', 'innovio'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'innovio'),
            'icon-social-twitter'     => esc_html__('Twitter', 'innovio'),
            'icon-social-youtube'     => esc_html__('Youtube', 'innovio')
        );
    }
