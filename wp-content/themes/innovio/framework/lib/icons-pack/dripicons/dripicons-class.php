...
if ( ! function_exists( 'innovio_mikado_add_dripicons_icon_pack' ) ) {
	function innovio_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new InnovioMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_dripicons_icon_pack_option' ) ) {
	function innovio_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_dripicons_icon_pack_option' );
}

class InnovioMikadoClassDripicons implements iInnovioMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
