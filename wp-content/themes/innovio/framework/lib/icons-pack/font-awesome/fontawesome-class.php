...
if ( ! function_exists( 'innovio_mikado_add_font_awesome_icon_pack' ) ) {
	function innovio_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new InnovioMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_font_awesome_icon_pack_option' ) ) {
	function innovio_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_social_options', 'innovio_mikado_add_font_awesome_icon_pack_option' );
}

class InnovioMikadoClassIconsFontAwesome implements iInnovioMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
