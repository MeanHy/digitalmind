...
if ( ! function_exists( 'innovio_mikado_add_ion_icon_pack' ) ) {
	function innovio_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new InnovioMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_ion_icon_pack_option' ) ) {
	function innovio_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_ion_icon_pack_option' );
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_social_options', 'innovio_mikado_add_ion_icon_pack_option' );
}

class InnovioMikadoClassIonIcons implements iInnovioMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
