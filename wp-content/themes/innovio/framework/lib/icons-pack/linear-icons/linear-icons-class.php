...
if ( ! function_exists( 'innovio_mikado_add_linear_icon_pack' ) ) {
	function innovio_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new InnovioMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_collection', 'innovio_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'innovio_mikado_add_linear_icon_pack_option' ) ) {
	function innovio_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'innovio' );
		
		return $options;
	}
	
	add_filter( 'innovio_mikado_filter_add_icon_pack_into_options', 'innovio_mikado_add_linear_icon_pack_option' );
}

class InnovioMikadoClassLinearIcons implements iInnovioMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
